...
aiken blueprint apply -o plutus.json -v seedelf.always_false.else "${ran_cbor}"
aiken blueprint convert -v seedelf.always_false.else > contracts/always_false_contract.plutus
