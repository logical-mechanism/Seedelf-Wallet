...
aiken blueprint apply -o plutus.json -v batcher.contract.spend "${ran_cbor}"
aiken blueprint convert -v batcher.contract.spend > contracts/batcher_contract.plutus
cardano-cli conway transaction policyid --script-file contracts/batcher_contract.plutus > hashes/batcher.hash
echo -e "\033[1;33m Batcher Contract Hash: $(cat hashes/batcher.hash) \033[0m"
