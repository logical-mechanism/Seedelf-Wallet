# Seedelf brand assets

The original logo set, at full size. The extension ships smaller copies made from these (see `extension/public/`).
...
**Colours taken from the logo:** navy `#011833`, deep navy `#000c2c`, bright teal `#00c4bc`, mid teal `#00a8a0`, deep green-teal `#01836e`.

The resized copies were made with Pillow: the emblem cropped to its alpha box and centred on a square canvas, and the wordmark cropped and scaled to 720 px wide.
