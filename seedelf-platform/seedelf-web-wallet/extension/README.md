...
| Move in | From Home | An ADA amount or Max, and tokens to bring along, picked with **Add tokens** (a search), each in any amount or its Max; then a review of what moves, the fee and the change; then Send |
...
src/
  ...
  ui/
    ...
    screens/            Onboarding, Create, Restore, Unlock (and reset), Home, Tokens, Receive, MoveIn,
                        CreateSeedelf, Transfer, Withdraw, RemoveSeedelf, Settings
