...
export function Manage() {
  ...
  const handleSubmit = async () => {
    ...
    if (network == "mainnet" && !address.includes("addr1")) return setMessage("Incorrect Mainnet Address Format");
    if (network == "preprod" && !address.includes("addr_test1")) return setMessage("Incorrect Pre-Production Address Format");
  ...
  return (
    <div className="w-full p-6">
      ...
      <div className={`${seedelfs.length === 0 ? "" : "rounded flex items-center justify-center max-w-1/2 mx-auto mt-8"}`}>
