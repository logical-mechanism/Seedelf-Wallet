...
fn test_complex_string_sha3_256() {
    ...
    let a: String = sha3_256(&format!("{}{}", asset_a_policy_id, asset_a_asset_name));
    let b: String = sha3_256(&format!("{}{}", asset_b_policy_id, asset_b_asset_name));
    let proof: String = sha3_256(&format!("{}{}", a, b));
