...
pub fn run(network_flag: bool) {
    ...
    println!("\n{}", "Select which steaming tokens you wish to purchase. Locate the Pointer Asset Name in the information box on the song page and copy that text. The pointer asset name is used as the locator token for the create command.".bright_blue());
